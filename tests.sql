...
SET @frag = (SELECT TOP 1 CAST(avg_fragmentation_in_percent as varchar(100)) FROM sys.dm_db_index_physical_stats(DB_ID(),OBJECT_ID(N'#t'),NULL,NULL,NULL))
...
SET @et = SYSUTCDATETIME()
SET @frag = (SELECT TOP 1 CAST(avg_fragmentation_in_percent as varchar(100)) FROM sys.dm_db_index_physical_stats(DB_ID(),OBJECT_ID(N'#t2'),NULL,NULL,NULL))
